public class Driver {
	/*
	 * final variable are in capital letter by convention
	 * These instance variables will act as constants through out the project
	 * for static variable we do not need to create an object of this class
	 */
	...
	/*
	 * This function contains the actual  logic and help to decide who won
	 * the 1 represent winning and the -1 represent no wining and 0 represent tie
	 */
